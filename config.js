...
cfg.googlemapsDirectory = './googlemaps/';
cfg.requiredDirectories = [cfg.plotlyDirectory, cfg.webcamDirectory, cfg.googlemapsDirectory]; // these folders will be made with mkdir
