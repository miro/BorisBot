...
//      There isn't much yet, but in future we would like to move all the "talk logic"
//      from controllers into this module.
//
//      Controllers should only be responsible for fetching & modifying data in DB, and brain should
//      output that data to the users.
//
//      Not to be mixed with talkbox.js; it is responsible for parsing "natural language" coming
//      from users, this module is for CREATING "natural language" from the bot data.
...
brain.answerIltaa = function(event) {
    if (Math.random() * 100 < 10) {
        ...
        var illat = [
            'iltaa', 'iltes', 'iltua', 'NÄYTÄ SITÄ ILTUA!', 'ILTAA',
            'Hyvää iltaa.', 'NÄYTÄ HERRAN TÄHDEN SITÄ ILTUA!', 'velu: rupale',
            'Olisko tänään iltua?', '/iltaa <iltua>', '!expl iltua',
            'Sinun kannattaa ensiksi täyttää profiilisi, että muut voivat tutustua sinuun.',
            '#spännimobi: kannattaa tulla kanavalle, niin saat tietoa tulevista tapahtumista',
